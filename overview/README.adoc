...
image::figs/jason-ros-agent-russel-norvig.drawio-5.png-1.png[width=50%]
...
image::figs/embedded_mas_overall_arhiteture.png[width=50%]
...
.Physical portion
image::figs/embedded_mas_overall_arhiteture-microcontroller.png[width=50%]
...
.Agent code
image::figs/embedded_mas_overall_arhiteture-asl_code.png[width=50%]
...
.Agent execution
image::figs/embedded_mas_overall_arhiteture-agent_reasoning.png[width=50%]
...
.Physical device interface
image::figs/embedded_mas_overall_arhiteture-device.png[width=50%]
...
.Physical interfaces
image::figs/embedded_mas_overall_arhiteture-physical.png[width=50%]
